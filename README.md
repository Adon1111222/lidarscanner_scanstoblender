# Lidar Scanner 2 Scans To Blender
...
All strings must be closed with quotes.<br>
**Values:** <br>
(string) **Filename**: *Full path to the scans file.* <br>
(string) **Collectionname**: *Name of the collection to save dots to.* <br>
(float) **div**: *How much the dots will be close to the world origin.* <br>
(float) **dotssize**: *Size of dots, in meters.* <br>
